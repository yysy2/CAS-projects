...
import myfunctions_leaf_p as mf
...
hidden_layer_size1 = 50             # hidden units, unless allow_optimisation = True
hidden_layer_size2 = 200            # hidden units, unless allow_optimisation = True, ignored if number_of_layers = 3
...
lambda_reg = 0.008                    # Regularisation parameter, allow_optimisation = True
...
##Minimiser options
iteration_number = 1000               # Number of iterations
...
lambda_reg_upper_threshold = 0.300  #300.0   #350.0  # Sets the max lambda threshold for optimisation
d1_reg_lower_threshold = 25         # Sets the min d1 threshold for optimisation
d1_reg_upper_threshold = 1000       # Sets the max d1 threshold for optimisation
d2_reg_lower_threshold = 25         # Sets the min d1 threshold for optimisation
d2_reg_upper_threshold = 1000       # Sets the max d1 threshold for optimisation
d3_reg_lower_threshold = 25         # Sets the min d1 threshold for optimisation
d3_reg_upper_threshold = 1000       # Sets the max d1 threshold for optimisation
